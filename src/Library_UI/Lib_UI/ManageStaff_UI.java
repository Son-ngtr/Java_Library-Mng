...
// create table content
        String[][] tableData = {{"01", "Nguyen Van A", "Male", "25/10/1991", "Le Thanh Nghi","+84 123 758 851",  "librarian"}};

        String[] tableColumn = {"ID", "NAME", "GENDER", "YEAR.BORN","ADDRESS", "PHONE.NB", "STAFF"};
