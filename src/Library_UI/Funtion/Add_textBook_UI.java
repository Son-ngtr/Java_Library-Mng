...
public class Add_textBook_UI {
    ...
    private JComboBox cb_7, cb_8, cbEducation, cbEducationType, cb;
    private JTable table;
    private Check check = new Check();

    //Constructor
    public Add_textBook_UI(BookManager bookManager){
    ...
    public void tableReset(){
        ...
        table.getColumnModel().getColumn(8).setCellEditor(new DefaultCellEditor(cbEducation));
        table.getColumnModel().getColumn(9).setCellEditor(new DefaultCellEditor(cbEducationType));
