...
public class Add_childrenBook_UI {
    ...
    private JComboBox cb_7, cb_8, cbChildType, cbChildRecommentForAge, cb;
    private JTable table;
    private Check check = new Check();

    //Constructor
    public Add_childrenBook_UI(BookManager bookManager){
...
// create 6 button
        ...
        JButton b8 = new JButton("~ age_rcm");
...
// create 6 text fields
        ...
        cb_8 = new JComboBox(new String[]{"6->10", "11->16", "16+"});
...
// set combo box
    cb.setSelectedItem("Children Book");
    cb.setEnabled(false);
